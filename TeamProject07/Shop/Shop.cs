...
namespace TeamProject07.Shop
{
    internal class Shop
    {
        ...
        public static void Buy()
        {
            ...
            while (true)
            {
                ...
                while (true)
                {
                    ...
                    if ((Kill_buy == true)||(Again_buy==true))
                    {
                        break;
                    }
                }
        ...
        static public void Sell()
        {
            ...
            while(true)
            {
                bool Kill_sell = false;
                bool Again_sell = false;
                ...
                while (true)
                {
                    ...
                    if ((Kill_sell == true)||(Again_sell==true))
                    {
                        break;
                    }
